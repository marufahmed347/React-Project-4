...
export const ProblemSolutionCard = ({image,title,des1,des2}) => {
  return (
    ...
    <div className='transition-colors duration-200 w-[272px] h-[349px] rounded-[20px] p-5 space-y-5 shadow-card hover:bg-primary group'>
        <div className='bg-primary size-[58px] rounded-full justify-center items-center'>
            <img src={image} alt="" />
        </div>
        <h1 className='font-bold group-hover:text-white text-lg text-secondary leading-none'>{title}</h1>
